...
BEGIN
  ...
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000345') AND "tenantId" = t_id LIMIT 1), p_id), 15, 61000, 915000 FROM new_ord;
  -- Order HD078656
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000396') AND "tenantId" = t_id LIMIT 1), p_id), 2, 160000, 320000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000345') AND "tenantId" = t_id LIMIT 1), p_id), 15, 61000, 915000 FROM new_ord;
  -- Order HD078551
  WITH new_ord AS (
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  -- Order HD078472
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 20, 61000, 1220000 FROM new_ord;
  -- Order HD077145.01
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000113') AND "tenantId" = t_id LIMIT 1), p_id), 10, 90000, 900000 FROM new_ord;
  -- Order HD076887
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000345') AND "tenantId" = t_id LIMIT 1), p_id), 15, 61000, 915000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000213') AND "tenantId" = t_id LIMIT 1), p_id), 10, 45000, 450000 FROM new_ord;
  -- Order HD076520
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000213') AND "tenantId" = t_id LIMIT 1), p_id), 15, 45000, 675000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  -- Order HD075695
  WITH new_ord AS (
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP04') AND "tenantId" = t_id LIMIT 1), p_id), 5, 50000, 250000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000226') AND "tenantId" = t_id LIMIT 1), p_id), 1, 62000, 62000 FROM new_ord;
  -- Order HD073665
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000252') AND "tenantId" = t_id LIMIT 1), p_id), 12.15, 50000, 607500 FROM new_ord;
  -- Order HD071864
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('G005') AND "tenantId" = t_id LIMIT 1), p_id), 15, 45000, 675000 FROM new_ord;
  -- Order HD071688
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000451') AND "tenantId" = t_id LIMIT 1), p_id), 5, 87000, 435000 FROM new_ord;
  -- Order HD070963
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000073') AND "tenantId" = t_id LIMIT 1), p_id), 15, 45000, 675000 FROM new_ord;
  -- Order HD070145
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000073') AND "tenantId" = t_id LIMIT 1), p_id), 15, 45000, 675000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000451') AND "tenantId" = t_id LIMIT 1), p_id), 3, 87000, 261000 FROM new_ord;
  -- Order HD069328
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000213') AND "tenantId" = t_id LIMIT 1), p_id), 15, 46000, 690000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000333') AND "tenantId" = t_id LIMIT 1), p_id), 2.1, 80000, 168000 FROM new_ord;
  -- Order HD068879
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000135') AND "tenantId" = t_id LIMIT 1), p_id), 3, 72000, 216000 FROM new_ord;
  -- Order HD068148
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000333') AND "tenantId" = t_id LIMIT 1), p_id), 2.4, 80000, 192000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  -- Order HD067669
  WITH new_ord AS (
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000113') AND "tenantId" = t_id LIMIT 1), p_id), 11.55, 90000, 1039500 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000345') AND "tenantId" = t_id LIMIT 1), p_id), 15, 61000, 915000 FROM new_ord;
  -- Order HD066953
  WITH new_ord AS (
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('G021') AND "tenantId" = t_id LIMIT 1), p_id), 5, 50000, 250000 FROM new_ord;
  -- Order HD066722
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000333') AND "tenantId" = t_id LIMIT 1), p_id), 2.2, 80000, 176000 FROM new_ord;
  -- Order HD066308
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000136') AND "tenantId" = t_id LIMIT 1), p_id), 15, 45000, 675000 FROM new_ord;
  -- Order HD065880
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000451') AND "tenantId" = t_id LIMIT 1), p_id), 10, 80000, 800000 FROM new_ord;
  -- Order HD065801
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000473') AND "tenantId" = t_id LIMIT 1), p_id), 5, 80000, 400000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  -- Order HD065683
  WITH new_ord AS (
  ...
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000333') AND "tenantId" = t_id LIMIT 1), p_id), 2.15, 80000, 172000 FROM new_ord;
  -- Order HD064684
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000333') AND "tenantId" = t_id LIMIT 1), p_id), 2, 75000, 150000 FROM new_ord;
  -- Order HD063995.01
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
  ...
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('G002') AND "tenantId" = t_id LIMIT 1), p_id), 15, 45000, 675000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  -- Order HD063036.01
  WITH new_ord AS (
  ...
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000088') AND "tenantId" = t_id LIMIT 1), p_id), 10, 61000, 610000 FROM new_ord;
  INSERT INTO "OrderItem" ("orderId", "productId", quantity, price, total)
  SELECT id, COALESCE((SELECT id FROM "Product" WHERE LOWER(sku) = LOWER('SP000078') AND "tenantId" = t_id LIMIT 1), p_id), 15, 51000, 765000 FROM new_ord;
  -- Order HD062726.01
  WITH new_ord AS (
    INSERT INTO "Order" (code, "customerId", "userId", "tenantId", status, total, paid, subtotal, "createdAt", "updatedAt")
